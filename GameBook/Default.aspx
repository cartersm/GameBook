...
<asp:Content runat="server" ID="FeaturedContent" ContentPlaceHolderID="FeaturedContent">
    <section class="featured">
        <div class="content-wrapper">
            <hgroup class="title">
                <!-- <h1><%: Title %>.</h1> -->
                <h2><strong>Welcome to GameBook. </strong><br /><i>The social network for video game characters.</i></h2>
            </hgroup>
            <!--
            <p>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    To begin sharing your favorite times in the gaming world, click the "Register" button in the upper right corner. <br />
